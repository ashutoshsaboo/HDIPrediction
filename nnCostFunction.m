function [J grad hx] = nnCostFunction(nn_params, input_layer_size, hidden_layer_size, num_labels, X, y, lambda)
...
temp1 = temp1 .^ 2;
temp2 = temp2 .^ 2;
J = J + ( (sum(sum(temp1,2),1) + sum(sum(temp2,2),1)) * (lambda/(2*m)));
